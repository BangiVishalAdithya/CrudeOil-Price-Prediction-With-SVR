...
# Plot data out
    ...
    plt.xlabel('A number of days since Jan 1, 2018')
    ...
    plt.legend()
    plt.show()
    data={'lr':linear_pred[last_day],'lr':linear_pred[last_day + 29],'lr':linear_pred[last_day + 364],'SVR':svr_rbf_pred[last_day],'SVR':svr_rbf_pred[last_day + 29],'SVR':svr_rbf_pred[last_day + 364]}
